...
const primaryColor = Color(0xFF94C6AD);
const accentColor = Color(0xFF60BBD6);
...
final usernameValidator = MultiValidator([
  ...
  MinLengthValidator(3, errorText: 'Username must be at least 3 characters long'),
  MaxLengthValidator(20, errorText: 'Username must be less than 20 characters'),
  PatternValidator(r'^[a-zA-Z0-9_]+$', errorText: 'Username can only contain letters, numbers, and underscores'),
]);
